    ...
    <RoomStyle id="page-room">
      ...
      <main className="content">
        ...
        <form onSubmit={handleSendQuestion}>
          <textarea className="form__textarea" name="" id="" cols={30} rows={5} placeholder="O que você quer perguntar?" onChange={event => setNewQuestion(event.target.value)} value={newQuestion} />
          ...
          <div className="form__footer">
            {user ? (
              ...
              <span className="form__info">Para enviar uma pergunta, <button className="form__link">faça seu login</button>.</span>
            )}
            <Button
              type="submit"
              variant="primary"
